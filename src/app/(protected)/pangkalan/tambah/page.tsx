...
export default function TambahPangkalanPage() {
  ...
  // Ambil daftar pangkalan utama untuk pilihan "Pangkalan Lain"
  useState(() => {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <p className="mt-1.5 text-[10px] text-slate-400">
              Pilih pangkalan utama jika pangkalan baru ini merupakan cabang atau dikelola oleh penanggung jawab yang sama.
            </p>
          </div>
